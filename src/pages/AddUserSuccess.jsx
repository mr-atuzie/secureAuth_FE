...
const AddUserSuccess = () => {
  ...
  return (
    <div className=" font2 relative w-full min-h-screen flex justify-center items-center">
      <button
        onClick={() => navigate(-1)}
        className="  flex font-semibold absolute top-2 left-2 items-center justify-center gap-2 "
      >
        <IoIosArrowBack />
