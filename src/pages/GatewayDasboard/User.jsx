    ...
    <>
      <section className=" font2 w-full min-h-screen">
        ...
        <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className=" p-3 bg-white   border border-gray-200 rounded-[10px]">
            <h3 className=" font-medium tracking-wide text-[11px] uppercase text-[#71717A]">
              Total number of users (business)
            </h3>
          ...
          <div className=" p-3 bg-white   border border-gray-200 rounded-[10px]">
            <h3 className=" font-medium tracking-wide text-[11px] uppercase text-[#71717A]">
              number of active users (business)
            </h3>
          ...
          <div className=" p-3 bg-white   border border-gray-200 rounded-[10px]">
            <h3 className=" font-medium tracking-wide text-[11px] uppercase text-[#71717A]">
              Number of inactive user (Business)
            </h3>
          ...
          <div className=" p-3 bg-white   border border-gray-200 rounded-[10px]">
            <h3 className=" font-medium tracking-wide text-[11px] uppercase text-[#71717A]">
              Total number of users (Aggregators)
            </h3>
          ...
          <div className=" p-3 bg-white   border border-gray-200 rounded-[10px]">
            <h3 className=" font-medium tracking-wide text-[11px] uppercase text-[#71717A]">
              number of active users (Aggregators)
            </h3>
          ...
          <div className=" p-3 bg-white   border border-gray-200 rounded-[10px]">
            <h3 className=" font-medium tracking-wide text-[11px] uppercase text-[#71717A]">
              Number of inactive user (Aggregators)
            </h3>
          ...
          <div className=" p-3 bg-white   border border-gray-200 rounded-[10px]">
            <h3 className=" font-medium tracking-wide text-[11px] uppercase text-[#71717A]">
              Total number of user Each of the business user category
            </h3>
          ...
          <div className=" p-3 bg-white   border border-gray-200 rounded-[10px]">
            <h3 className=" font-medium tracking-wide text-[11px] uppercase text-[#71717A]">
              number of active users Each of the business user category
            </h3>
          ...
          <div className=" p-3 bg-white   border border-gray-200 rounded-[10px]">
            <h3 className=" font-medium tracking-wide text-[11px] uppercase text-[#71717A]">
              number of inactive users Each of the business user category
            </h3>
